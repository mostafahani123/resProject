      ...
      <div class="row">
        <div class="col-12">
          <div class="card mb-4">
            ...
            <div class="card-body">
                <form role="form text-left" method="POST" action="{{url("/createItem")}}" enctype="multipart/form-data">
                  @csrf
                  <div class="mb-3">
                    <input type="text" class="form-control" placeholder="Name"value="{{ old('name')  }}" aria-label="Name"  name="name">
                    @error('name')
                  ...
                  <div class="mb-3">
                    <input type="text" class="form-control" placeholder="price" value="{{ old('price')  }}" aria-label="price"  name="price">
                    @error('price')
                    <div class="alert alert-danger mt-" role="alert">
                      {{$message}}
                    </div>
                  ...
                  <div class="mb-3">
                    <input type="text" class="form-control" placeholder="descraption" value="{{ old('descraption')  }}" aria-label="descraption" name="descraption">
                    @error('descraption')
                    <div class="alert alert-danger mt-" role="alert">
                      {{$message}}
                    </div>
                  ...
                  <div class="mb-3">
                    <input type="file" class="form-control" placeholder="image" value="{{ old('image')  }}" aria-label="image" name="image">
                    @error('image')
                    <div class="alert alert-danger mt-" role="alert">
                      {{$message}}
                    </div>
                  ...
                  <div class="text-center">
                    <button type="submit" class="btn bg-gradient-dark w-100 my-4 mb-2">create item</button>
