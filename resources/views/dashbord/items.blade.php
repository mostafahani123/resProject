                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Descraption</th>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>
                        <div >
                          <div>
                            <img src="{{asset($data->image)}}" class="avatar avatar-sm me-3" alt="user1">
                          </div>
                      ...
                      <td>
                        <p class="text-xs font-weight-bold mb-0"> {{$data->descraption}}</p>
                        
                      </td>
                      <td class="align-middle text-center text-sm">
                        <span class="badge badge-sm bg-gradient-success">{{$data->created_at}}</span>
                      </td>
                      ...
                      <td class="align-middle">
                         ...
                         <button class="btn btn-success"><a href="{{ url("/edit", $data->id)}}"  data-toggle="tooltip" data-original-title="Edit user">Edit</a></button> 
                        
                          <button class="btn btn-danger"><a href="{{ url("/delete", $data->id)}}"  data-toggle="tooltip" data-original-title="Edit user">delete</a></button> 
