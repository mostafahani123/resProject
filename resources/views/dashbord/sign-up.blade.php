        ...
        <div class="row mt-lg-n10 mt-md-n11 mt-n10">
          <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
            <div class="card z-index-0">
              ...
              <div class="card-body">
                <form role="form text-left" method="POST" action="{{ url('/sign-up') }}" enctype="multipart/form-data">
                  @csrf
                  <div class="mb-3">
                    <label for="name"> full name</label>
                    <input type="text" class="form-control" placeholder="full Name"  value="{{ old('FullName')  }}" aria-label="Name" aria-describedby="email-addon" name="FullName">
                    @error('FullName')
                  ...
                  <div class="mb-3">
                    ...
                    <input type="file" class="form-control" placeholder="Name" value="{{ old('Image')  }}"   aria-describedby="password-addon" name="Image">
                    @error('Image')
                    <div class="alert alert-danger mt-" role="alert">
                      {{$message}}
                    </div>
                  ...
                  <div class="mb-3">
                    ...
                    <input type="email" class="form-control" placeholder="Email" value="{{ old('Email')  }}"  aria-label="Email" aria-describedby="email-addon" name="Email">
                    @error('Email')
                    <div class="alert alert-danger mt-" role="alert">
                      {{$message}}
                    </div>
                  ...
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" placeholder="Mobile" value="{{ old('mobile')  }}"  aria-label="mobile" aria-describedby="email-addon" name="mobile">
                    @error('mobile')
                    <div class="alert alert-danger mt-" role="alert">
                      {{$message}}
                    </div>
                  ...
                  <input type="text" class="form-control" placeholder="country"  value="{{ old('location')  }}"  aria-label="Email" aria-describedby="email-addon" name="location">
                  @error('location')
                  <div class="alert alert-danger mt-" role="alert">
                    {{$message}}
                  </div>
                  ...
                  <div class="mb-3">
                    ...
                    <input type="password" class="form-control"  value="{{ old('password')  }}"placeholder="Password" aria-label="Password" aria-describedby="password-addon" name="password">
                    @error('password')
                    <div class="alert alert-danger mt-" role="alert">
                      {{$message}}
                    </div>
