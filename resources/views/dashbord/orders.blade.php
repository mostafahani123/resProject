                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-secondary opacity-7">ascas</th>
                    </tr>
                  </thead>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="align-middle">
                        <a href="{{ url("/profile" , $dataBook->id )}}" class="text-light bg-danger font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                          reject
                        </a>
                      </td>
                      <td class="align-middle">
