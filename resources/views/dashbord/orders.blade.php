                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">total preson</th>
                      ...
                      <td>
                        <div class="d-flex px-2 py-1">
                          ...
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm">{{$dataBook->name}}</h6>
                            <p class="text-xs text-secondary mb-0">{{$dataBook->phone}}</p>
                          </div>
                        </div>
                      </td>
                      <td>
                        <p class="text-xs font-weight-bold mb-0">{{$dataBook->totalphone}}</p>
                        
                      </td>
                      <td class="align-middle text-center text-sm">
                        <span class="badge badge-sm bg-gradient-success">{{$dataBook->date}}</span>
                      </td>
                      <td class="align-middle text-center">
                        <span class="text-secondary text-xs font-weight-bold">{{$dataBook->time}}</span>
                      </td>
                      
                  
                        <td class="align-middle">
                        
                          <button class="btn btn-success"><a href="{{ url("/request", $dataBook->id)}}"  data-toggle="tooltip" data-original-title="Edit user">Request</a></button> 
