      ...
      <div class="row">
        <div class="col-12">
          <div class="card mb-4">
            ...
            <div class="card-body">
                <form role="form text-left" method="POST" action="{{url("/edit",$product->id)}}" enctype="multipart/form-data">
                  @csrf
                  @method('PUT')
                  <div class="mb-3">
                    <input type="text" class="form-control" placeholder="Name" value="{{$product->name }}" aria-label="Name"  name="name">
                  
                  </div>
                  <div class="mb-3">
                    <input type="text" class="form-control" placeholder="price" value="{{$product->price}}" aria-label="price"  name="price">
                
                  </div>
                  
                  <div class="mb-3">
                    <input type="text" class="form-control" placeholder="descraption" value="{{$product->descraption}}" aria-label="descraption" name="descraption">
                   
              
                  </div>
                  <div class="mb-3">
                    <img src="{{asset($product->image)}}" alt="" style="width:200px;height:200px;">
                    <input type="file" class="form-control" placeholder="image" value="{{ $product->image }}" aria-label="image" name="image">
                    {{-- @error('image')
